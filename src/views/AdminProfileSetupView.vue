  ...
  <div class="flex items-center justify-center min-h-[60vh]">
    <form @submit.prevent="handleSubmit" class="w-full max-w-sm space-y-6">
      <div class="text-center">
        ...
        <p class="text-white/60 text-sm mt-2">Antes de continuar, necesitamos tu nombre.</p>
      </div>
      ...
      <div>
        ...
        <input id="displayName" v-model="displayName" type="text" required autocomplete="name"
